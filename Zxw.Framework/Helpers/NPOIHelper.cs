...
namespace Zxw.Framework.Helpers
{
    public class NPOIHelper
    {
        ...
        public static void ExportExcelByResponse(DataTable dtSource, string strHeaderText, string strFileName)
        {
            HttpContext curContext = HttpContext.Current;
            //设置编码和附件格式
            curContext.Response.AppendHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode(strFileName,Encoding.GetEncoding("GB2312")));
            curContext.Response.ContentType = "application/vnd.ms-excel";
            curContext.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
            curContext.Response.Charset = "GB2312";
            curContext.Response.BinaryWrite(ExportExcel(dtSource, strHeaderText).GetBuffer());
        ...
        /// <param name="strHeaderText">表头文本</param>
        /// <param name="strFileName">文件名</param>
        public static void ExportExcelByResponse(DataSet dsSource, string strHeaderText, string strFileName)
        {
            HttpContext curContext = HttpContext.Current;
            //设置编码和附件格式
            curContext.Response.AppendHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.GetEncoding("GB2312")));
            ...
            curContext.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
            curContext.Response.Charset = "GB2312";
            curContext.Response.BinaryWrite(ExportExcel(dsSource, strHeaderText).GetBuffer());
            curContext.Response.End();
